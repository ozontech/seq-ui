...
ALTER TABLE IF EXISTS user_profiles ADD COLUMN IF NOT EXISTS log_columns TEXT NOT NULL DEFAULT '[]';
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
ALTER TABLE IF EXISTS user_profiles DROP COLUMN IF EXISTS log_columns;
