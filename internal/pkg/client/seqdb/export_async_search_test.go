...
const asyncSearchTestSearchID = "69e4a4a6-0922-43bd-952d-060a86c2b622"

func Test_GRPCClient_ExportAsyncSearch(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "ok_jsonl",
			req: &seqapi.ExportAsyncSearchRequest{
				SearchId: asyncSearchTestSearchID,
				Limit:    3,
				Offset:   0,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			seqProxyMock.EXPECT().
				ExportAsyncSearch(ctx, mArgs.req).
			...
			err = c.ExportAsyncSearch(ctx, tt.req, cw)
