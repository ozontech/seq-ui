					...
					Events: []*seqapi.Event{
						{
							...
							Time: timestamppb.New(testTimestamp.Add(-1 * time.Minute)),
						},
						{
							...
							Time: timestamppb.New(testTimestamp.Add(-2 * time.Minute)),
						},
					},
					Total: 2,
							...
							Buckets: []*seqapi.Aggregation_Bucket{
								{
									...
									Value:     pointerTo[float64](2),
									NotExists: 0,
									Ts:        timestamppb.New(testTimestamp.Add(-30 * time.Second)),
								},
								{
									Key:       "33",
									Value:     pointerTo[float64](5),
									NotExists: 0,
									Ts:        timestamppb.New(testTimestamp),
								},
								{
									Key:       "22",
									Value:     pointerTo[float64](8),
									NotExists: 1,
									Ts:        timestamppb.New(testTimestamp.Add(-1 * time.Minute)),
								},
							},
							NotExists: 2,
						},
